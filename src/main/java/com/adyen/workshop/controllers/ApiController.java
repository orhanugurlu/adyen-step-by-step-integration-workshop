...
public class ApiController {
    ...
    public ResponseEntity<PaymentResponse> payments(@RequestBody PaymentRequest body) throws IOException, ApiException {
        ...
        paymentRequest.setReturnUrl("https://symmetrical-umbrella-rr45vv99542wpxp-8080.app.github.dev/handleShopperRedirect");
        ...
        paymentRequest.setOrigin("https://symmetrical-umbrella-rr45vv99542wpxp-8080.app.github.dev");
    ...
    public RedirectView redirect(@RequestParam(required = false) String payload, @RequestParam(required = false) String redirectResult) throws IOException, ApiException {
        ...
        var redirectURL = "https://symmetrical-umbrella-rr45vv99542wpxp-8080.app.github.dev/result/"; // Update your url here by replacing `http://localhost:8080` with where your application is hosted (if needed)
